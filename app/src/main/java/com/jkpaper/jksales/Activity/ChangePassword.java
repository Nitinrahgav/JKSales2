...
public class ChangePassword extends AppCompatActivity implements View.OnClickListener{
    ...
    private void requestPasswordChange() {
        ...
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .build();
        Request request = new Request.Builder().url("http://nitinraghav.com/jkapi/update_profile.php").addHeader("Token","d75542712c868c1690110db641ba01a").addHeader("Data-For","2").post(requestBody).build();
